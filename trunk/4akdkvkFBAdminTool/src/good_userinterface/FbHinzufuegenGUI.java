...
public class FbHinzufuegenGUI 
{
	...
	public void panelCenterEdit()
	{
		...
		button4.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0) 
			{
				FbHinzufuegen.getFb1().setFragenList(tableModel1.gibFragenArray());
				//FbHinzufuegen.gib_Klasse().getFb1().setFragenList(tableModel1.gibFragenArray());
	...
	{
		tableModel1.arrayListEinfuegen(FbHinzufuegen.getFb1().getFragenList());
		tableModel1.fireTableDataChanged();
		aendereStatusLabel();
	}
}
