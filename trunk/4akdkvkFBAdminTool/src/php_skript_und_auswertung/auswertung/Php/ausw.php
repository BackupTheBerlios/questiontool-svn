<?php
include "config.php";
//Zeigt die Tortengraphiken und die Bankendiagramme an.
//Die Diagramme werden über images eingefügt. Die Images werden in Echtzeit über ein PHP-Skript gerendert.
//Verwendet wird das Framework PHPLot
$_GET['FID'] = 16;
