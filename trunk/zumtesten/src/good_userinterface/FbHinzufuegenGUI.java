...
public class FbHinzufuegenGUI
{
	...
	// Button um Zurück zum Menü zu kommen
	...
	public FbHinzufuegenGUI()
	{
		...
		button5 = new JButton("Zurück zum Menü");
	...
	public void panelCenterEdit()
	{
		...
		thisWindow3.setTitle("Fragebogen hinzufügen");
		...
		button4 = new JButton("Abspeichern und Abschließen");
		//ALLES SPEICHERN
		button4.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				//Deaktiviert den Button, damit der User den Fragebogen nicht öfters ausfüllen kann.
			...
			{
				JOptionPane.showMessageDialog(hauptfenster,
	                         "Sie haben keine Fragen hinzugefügt",
	                         "Achtung",
	                         JOptionPane.INFORMATION_MESSAGE);
			}
		}
		...
		{
			//Vorhande Fragen hinzüfügen in einer Jlist
			...
			panelButton.add(jScrollPane1);
			{
				...
				JButton altefragehinzufuegen = new JButton ("Frage hinzufügen");
				altefragehinzufuegen.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						frageid++; //fangt bei null an zu zählen in der liste sonst währe F_ID falsch
						try {
						...
						// dbo.haben tabelle die fremdschlüssel bezeiehungen setzen
